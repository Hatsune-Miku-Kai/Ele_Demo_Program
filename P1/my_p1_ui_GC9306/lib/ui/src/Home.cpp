...
{
    drawStaticUI();
    UpdateCoord(0.0, 0.0, 0.0, 0.0);
    UpdateAngle(0.0, 0.0, 0.0, 0.0);
}
...
void Home::UpdateAngle(float j1, float j2, float j3)
{
    int rightX = 150;
    tft.setFreeFont(&FreeSans9pt7b);

    tft.fillRect(rightX, 70, 150, 30, TFT_BLACK);
    tft.fillRect(rightX, 95, 150, 30, TFT_BLACK);
    tft.fillRect(rightX, 120, 150, 30, TFT_BLACK);
