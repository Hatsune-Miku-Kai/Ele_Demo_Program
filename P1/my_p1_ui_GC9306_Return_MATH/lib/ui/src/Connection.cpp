...
void Connection::Handle_Button()
{
    ...
    if (btn == BTN3)
    {
        ...
        case 0://WLAN
        {
            WLAN_Information* wlan_information = new WLAN_Information(tft, button);
            ui_manager.RegisterScreen(wlan_information);
            button.Wait();
            ui_manager.Change_UI(wlan_information, true);
            break;
        }
