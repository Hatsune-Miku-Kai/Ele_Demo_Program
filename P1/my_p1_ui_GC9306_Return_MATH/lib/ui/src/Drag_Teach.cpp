...
void Drag_Teach::Handle_Button()
{
    ...
    if (btn == BTN3)
    {
        ...
        case 0: // Record
        {
            // Screen_Base *target = ui_manager.GetRegisteredScreenByID(ScreenID::ScreenID_Home);
            // auto home = static_cast<Home *>(target);
            // if (home)
            // {
            //     while(1)
            //         home->MyCobot_Pro_450_UI();
            // }
