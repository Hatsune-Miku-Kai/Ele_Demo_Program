#ifndef __FINE_TUNING_COORDS_H
#define __FINE_TUNING_COORDS_H
...
class Fine_Tuning_Coords : public Screen_Base
{
public:
    Fine_Tuning_Coords(TFT_eSPI& tft, Button& button);
    ~Fine_Tuning_Coords();
...
private:
    ...
    void UpdateCoords_450(float x, float y, float z, float rx, float ry, float rz);
    void MyCobot_Pro_450_UI();
    void MyCobot_Pro_450_Select();
    void Delete_Coords_Sprite();
    void Create_Coords_Sprite();
